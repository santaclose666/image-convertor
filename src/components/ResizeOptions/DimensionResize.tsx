    ...
    <div className="w-full">
      <div className="flex items-center justify-between w-full mb-4">
        <div className="flex flex-col w-1/2 pr-2">
          <label className="text-md mb-1 font-medium text-sky-300">Width</label>
          <input
            type="number"
            className="text-sky-500 border border-gray-400 rounded-md px-3 text-sm py-3 focus:outline-none focus:border-sky-400"
            value={width}
        ...
        <div className="flex flex-col w-1/2 pl-2">
          <label className="text-md mb-1 font-medium text-sky-300">
            Height
          </label>
          <input
            type="number"
